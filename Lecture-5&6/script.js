document.getElementById("button").addEventListener("click", list);
function list() {
  ...
  button.setAttribute(
    "onclick",
    "this.parentElement.style.background='rgba(69, 221, 48, 0.753)';this.parentElement.style.textDecoration='line-through'"
  );
